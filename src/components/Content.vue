<template>
    <div id="Content">
        ...
        >
            ...
            <span slot="footer" class="dialog-footer">请耐心等待，约一分钟......</span>
        </el-dialog>
        ...
        update(e) {
            ...
            axios
                ...
                .then(response => {
                    ...
                    this.percentage = 0;
                    this.notice1();
                    var areaCompare1 = document.getElementById("areaCompare");
                    areaCompare1.style.display = "none";
                    var areaCompare2 = document.getElementById("perimeterCompare");
                    areaCompare2.style.display = "none";
