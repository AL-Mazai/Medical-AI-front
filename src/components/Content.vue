        ...
        <div style="height: 600px" class="step_1">
          ...
          >
            <el-step style="height: 120px" title="步骤 1">
              <template style="font-size: 10px !important" #description>
                下载测试CT文件
                <!-- 下载文件 -->
                <el-button
                  type="primary"
    ...
    update(e) {
      ...
      axios
        ...
        .then((response) => {
          ...
          this.percentage = 0
          this.notice1()
          const areaCompare1 = document.getElementById('areaCompare');
          areaCompare1.style.display = 'none'
          const areaCompare2 = document.getElementById('perimeterCompare');
